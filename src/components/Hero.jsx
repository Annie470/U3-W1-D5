...
const Hero = () => {
  return (
    <Container fluid className="py-2 px-4 d-flex justify-content-between align-items-center" style={{ backgroundColor: '#221f1f' }}>
          ...
          <ButtonGroup className="ms-4 text-center">
            <Dropdown as={ButtonGroup}>
              <Dropdown.Toggle
                ...
                size="sm"
                className="rounded-0"
                style={{ backgroundColor: '#221f1f', borderColor: '#221f1f' }}
              >
                Genres
              </Dropdown.Toggle>

              <Dropdown.Menu  style={{ backgroundColor: '#221f1f', borderColor: '#221f1f' }}>
